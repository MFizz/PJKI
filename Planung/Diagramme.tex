...
\title{Planung LOAy}
\author{Christin Dressel\and\\Stefan Junghans\and\\Stefan Schirmeister\and\\Mitja Richter}
\date{24. April 2013}
...
\begin{document}
	...
	\section{Klassendiagramm des Gegenstandsbereichs}
		\begin{frame}
		\frametitle{Klassendiagramm des Gegenstandsbereichs}
			\includegraphics[scale=0.30]{bilder/Klassendiagramm.png}
		\end{frame}
		
	\section{Systemklassenmodell}
		\begin{frame}
		\frametitle{Systemklassenmodell}
			\includegraphics[scale=0.30]{bilder/Systemklassenmodell.png}
		\end{frame}
	...
	\section{Sequenzdiagramme}
		...
		\frametitle{Registrierung}
			\includegraphics[scale=0.30]{bilder/Registrierung.png}
		\end{frame}
		
		\begin{frame}
		\frametitle{Spielstart}
			\includegraphics[scale=0.30]{bilder/Spielstart.png}
		\end{frame}

		\begin{frame}
		\frametitle{Figurbewegung}
			\includegraphics[scale=0.30]{bilder/Figurbewegung.png}
		\end{frame}
